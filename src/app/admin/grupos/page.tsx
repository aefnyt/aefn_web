            ...
            {gruposLoading && (
              <Card>
                <CardContent className="flex items-center justify-center py-12">
                  ...
                  <span className="aefn-mono text-xs text-amber-600 uppercase tracking-wider">Cargando grupos...</span>
                </CardContent>
              </Card>
            )}
          ...
          <TabsContent value="papers">
            {papersLoading && (
              <Card>
                <CardContent className="flex items-center justify-center py-12">
                  <Loader2 className="w-4 h-4 text-amber-500 animate-spin mr-2" />
                  <span className="aefn-mono text-xs text-amber-600 uppercase tracking-wider">Cargando papers...</span>
                </CardContent>
              </Card>
            )}
          ...
          <TabsContent value="tesis">
            {tesisLoading && (
              <Card>
                <CardContent className="flex items-center justify-center py-12">
                  <Loader2 className="w-4 h-4 text-amber-500 animate-spin mr-2" />
                  <span className="aefn-mono text-xs text-amber-600 uppercase tracking-wider">Cargando tesis...</span>
                </CardContent>
              </Card>
            )}
