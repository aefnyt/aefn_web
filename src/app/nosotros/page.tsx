...
import { Atom, Beaker, GraduationCap, Globe2, Users, Mail } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <PageHeader
        ...
        title={<>La <span className="text-amber-400">asociación</span></>}
        description="La Asociación de Estudiantes de Física y Nanotecnología reúne a la comunidad estudiantil de la ECFN en Yachay Tech."
      />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl font-light text-neutral-900 leading-relaxed">
              Fomentar el desarrollo científico y académico de los estudiantes de Física y Nanotecnología,
              promoviendo la investigación, la colaboración interdisciplinaria y la difusión del conocimiento
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl font-light text-white leading-relaxed">
              Ser la comunidad estudiantil referente en ciencias físicas y nanotecnología en Ecuador,
              contribuyendo al desarrollo científico del país y formando a la próxima generación de
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="space-y-4 text-neutral-300 font-light leading-relaxed">
              <p>
                La Asociación de Estudiantes de Física y Nanotecnología nace como una iniciativa de los
                estudiantes de la Escuela de Ciencias Físicas y Nanotecnología de Yachay Tech para
                agrupar a la comunidad estudiantil y representar sus intereses académicos y científicos.
              </p>
              <p>
                A lo largo de los años, la asociación ha organizado congresos, observaciones astronómicas,
                charlas de divulgación científica y actividades de vinculación con la comunidad, consolidándose
                como un espacio de encuentro para los amantes de la física y la nanotecnología.
              </p>
              <p>
                Hoy, la AEFN sigue trabajando para fortalecer los lazos entre estudiantes, profesores e
                investigadores, y para promover el desarrollo científico en Ecuador desde la universidad.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-3xl font-light text-neutral-900 mb-6 leading-tight">
                Explora lo infinitesimal y lo cósmico
              </h2>
              <div className="space-y-4 text-neutral-600 font-light leading-relaxed">
                <p>
                  La Escuela de Ciencias Físicas y Nanotecnología se enfoca en el desarrollo de dos
                  departamentos (Física y Nanotecnología) que cubren la investigación fundamental y
                  aplicada, conformando áreas de investigación clave.
                </p>
                <p>
                  Esto provee un perfil altamente competitivo e internacional a los programas que ofertamos
                  a nivel de pregrado. Nuestro futuro programa de postgrado nos permite centrarnos en
                  problemas específicos que requieren ser resueltos a nivel nacional.
                </p>
              </div>
              <div className="mt-8 flex flex-wrap gap-4">
                <a
                  href="https://yachaytech.edu.ec/escuela-de-ciencias-fisicas-y-nanotecnologia/"
                  target="_blank"
            ...
            >
              {[
                ...
                <div key={s.label} className="border-t-2 border-neutral-200 pt-4">
                  ...
                  <div className="text-xs text-neutral-900 font-normal uppercase tracking-wider mb-1">
                    {s.label}
                  </div>
