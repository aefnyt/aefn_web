...
/* ============================================================
   ...
   ============================================================
   Principios de diseño (inspirados en physics.ox.ac.uk):
   - Secciones que alternan fondo negro / blanco (editorial)
   - Tipografía weight 400 (elegante, no agresiva)
   - Cards limpias con imagen + título + excerpt
   - Mucho whitespace, sin glow excesivo ni partículas
   - Dorado como acento sutil, no dominante
   ============================================================ */
...
/* ────────────────────────────────────────────────────────────
   NAVBAR — sobrio, transparente sobre hero, sólido al scroll
   ──────────────────────────────────────────────────────────── */
function Navbar() {
...
/* ────────────────────────────────────────────────────────────
   HERO — imagen a pantalla completa + overlay + título
   Estilo Oxford: imagen grande, texto sobre overlay
   ──────────────────────────────────────────────────────────── */
function Hero() {
...
/* ────────────────────────────────────────────────────────────
   STATS — barra sobria con métricas
   ──────────────────────────────────────────────────────────── */
function Stats() {
  const stats = [
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((s, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="text-3xl lg:text-4xl font-light text-amber-400 mb-1">
                {s.value}
              </div>
              <div className="text-xs text-neutral-400 uppercase tracking-wider font-light">
                {s.label}
              </div>
            </motion.div>
          ))}
...
/* ────────────────────────────────────────────────────────────
   ÁREAS — sección clara, cards editoriales
   ──────────────────────────────────────────────────────────── */
function Areas() {
  const areas = [
    {
      ...
      skills: [
        ...
        "Electromagnetismo y física estadística",
        "Astrofísica y cosmología",
        "Sistemas complejos y computacional",
      ],
    ...
    <section id="areas" className="bg-white py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light text-neutral-900 mb-4 leading-tight">
            Pilares de la comunidad
          </h2>
          <p className="text-neutral-600 text-lg font-light leading-relaxed">
            Tres ejes que articulan la vida académica y científica de la asociación,
            inspirados en la tradición investigativa de las mejores escuelas de física del mundo.
          </p>
        </motion.div>
          ...
          {areas.map((area, i) => (
            ...
            >
              <div className="border-t-2 border-neutral-200 pt-6 group-hover:border-amber-400 transition-colors">
                ...
                <h3 className="text-2xl font-normal text-neutral-900 mb-3">
                  {area.title}
                </h3>
                ...
                <ul className="space-y-2 mb-6">
                  {area.skills.map((skill) => (
                    <li
                      key={skill}
                      className="flex items-start gap-2 text-sm text-neutral-700 font-light"
                    >
...
/* ────────────────────────────────────────────────────────────
   INVESTIGACIÓN — sección oscura, líneas de investigación
   ──────────────────────────────────────────────────────────── */
function Research() {
  const lines = [
    {
      title: "Materiales Nanoestructurados",
      desc: "Síntesis, diseño y caracterización de materiales en nanoescala utilizando técnicas avanzadas de fabricación y análisis espectroscópico.",
    },
    {
      title: "Ciencia de Materiales Teórica",
      desc: "Modelado computacional y simulación de propiedades electrónicas, magnéticas y estructurales de materiales novedosos.",
    },
    {
      title: "Sistemas Complejos",
      desc: "Estudio de sistemas dinámicos no lineales, redes complejas y física estadística aplicada a problemas interdisciplinarios.",
    },
    {
      title: "Astrofísica y Cosmología",
      desc: "Investigación teórica en astrofísica, cosmología física y gravitación, con énfasis en materia oscura y energía oscura.",
    },
    {
      title: "Óptica y Fotónica",
      desc: "Estudio de la interacción luz-materia, óptica cuántica y desarrollo de sensores fotónicos para aplicaciones industriales.",
    },
    {
      title: "Energía y Sostenibilidad",
      desc: "Desarrollo de materiales para energía solar, almacenamiento energético y tecnologías limpias con impacto ambiental positivo.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-neutral-400 text-lg font-light leading-relaxed">
            La Escuela de Ciencias Físicas y Nanotecnología desarrolla investigación
            fundamental y aplicada en líneas alineadas con los desafíos científicos del siglo XXI.
          </p>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-neutral-800">
          {lines.map((line, i) => (
            <motion.div
              ...
              whileInView="show"
              viewport={{ once: true }}
              className="bg-neutral-950 p-8 group cursor-pointer hover:bg-neutral-900 transition-colors"
            >
              <h3 className="text-lg font-normal text-white mb-3 group-hover:text-amber-400 transition-colors">
                {line.title}
              </h3>
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 text-sm text-amber-400 hover:text-amber-300 transition-colors font-normal border-b border-amber-400/30 hover:border-amber-400 pb-1"
          >
...
/* ────────────────────────────────────────────────────────────
   NEWS — estilo Oxford: cards blancas sobre fondo oscuro
   ──────────────────────────────────────────────────────────── */
function News() {
  const news = [
    {
      cat: "Investigación",
      date: "8 julio 2026",
      title: "Estudiantes publican en Nature Nanotechnology sobre nanomateriales 2D",
      excerpt:
        "Grupo de investigación de la ECFN caracteriza propiedades electrónicas de materiales bidimensionales con aplicaciones en fotovoltaica.",
      featured: true,
    },
    {
      cat: "Evento",
      date: "5 julio 2026",
      title: "III Congreso Nacional de Física amplía inscripciones",
      excerpt: "Inscripciones abiertas hasta el 30 de julio para estudiantes de todo el país.",
    },
    {
      cat: "Club",
      date: "2 julio 2026",
      title: "Club de Astronomía organiza observación nocturna",
      excerpt: "Evento abierto al público con telescopios en el campus de Yachay Tech.",
    },
    {
      cat: "Académico",
      date: "28 junio 2026",
      title: "Defensa de tesis: computación cuántica aplicada",
      excerpt: "Estudiante defiende trabajo de titulación en algoritmos cuánticos.",
    },
  ];
    ...
    <section className="bg-neutral-950 py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <a
            href="/noticias"
            className="inline-flex items-center gap-1.5 text-sm text-amber-400 hover:text-amber-300 transition-colors font-normal border-b border-amber-400/30 hover:border-amber-400 pb-1"
          >
            Ver todas
            <ArrowRight className="w-4 h-4" />
          </a>
          ...
          >
            <div className="aspect-[16/10] bg-gradient-to-br from-neutral-800 to-neutral-950 overflow-hidden relative">
              <div className="absolute inset-0 flex items-center justify-center">
                <Atom
                  className="w-20 h-20 text-amber-400/20"
                  strokeWidth={1}
                />
              </div>
              <div className="absolute top-4 left-4 text-xs font-light text-amber-400 uppercase tracking-widest bg-black/40 px-3 py-1">
                Destacada
              </div>
            </div>
            <div className="p-6">
              <div className="flex items-center gap-3 mb-3 text-xs">
                <span className="text-amber-600 font-normal uppercase tracking-wider">
                  {featured.cat}
                </span>
                <span className="text-neutral-400 font-light">{featured.date}</span>
              </div>
              <h3 className="text-xl font-normal text-neutral-900 mb-3 leading-snug group-hover:text-amber-700 transition-colors">
                {featured.title}
              </h3>
          ...
          <div className="space-y-px bg-neutral-800">
            {rest.map((n, i) => (
              <motion.a
                ...
                whileInView="show"
                viewport={{ once: true }}
                className="group block bg-white p-6 hover:bg-neutral-50 transition-colors"
              >
                ...
                <h4 className="font-normal text-neutral-900 text-base leading-snug group-hover:text-amber-700 transition-colors mb-2">
                  {n.title}
                </h4>
...
/* ────────────────────────────────────────────────────────────
   PROFESSORS — sección clara, grid de retratos
   ──────────────────────────────────────────────────────────── */
function Professors() {
  const profesores = [
    ...
    <section className="bg-white py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-neutral-600 text-lg font-light leading-relaxed">
            Académicos que lideran los grupos de investigación de la Escuela
            de Ciencias Físicas y Nanotecnología.
          </p>
        </motion.div>
          ...
          {profesores.map((p, i) => (
            ...
            >
              <div className="aspect-[3/4] bg-gradient-to-br from-neutral-100 to-neutral-200 mb-4 overflow-hidden flex items-center justify-center relative">
                <span className="text-4xl font-light text-neutral-400 group-hover:text-amber-500 transition-colors">
                  {p.iniciales}
                </span>
              </div>
              <h3 className="font-normal text-neutral-900 text-base mb-1 group-hover:text-amber-700 transition-colors">
                {p.nombre}
              </h3>
        ...
        >
          <a
            href="/profesores.html"
            className="inline-flex items-center gap-2 text-sm text-amber-600 hover:text-amber-700 transition-colors font-normal border-b border-amber-400/30 hover:border-amber-400 pb-1"
          >
...
/* ────────────────────────────────────────────────────────────
   EVENTS — sección oscura, lista de eventos próximos
   ──────────────────────────────────────────────────────────── */
function Events() {
  const eventos = [
    {
      date: "15",
      month: "JUL",
      title: "Nanoscience Summer School Yachay 2026",
      type: "Académico",
      location: "Campus Yachay Tech",
    },
    {
      date: "22",
      month: "JUL",
    ...
    },
    {
      date: "05",
      month: "AGO",
      title: "Defensa de tesis: Materiales 2D",
      type: "Académico",
      location: "Auditorio ECFN",
    },
  ];
        ...
        <div className="space-y-px bg-neutral-800">
          {eventos.map((e, i) => (
            <motion.a
              ...
              whileInView="show"
              viewport={{ once: true }}
              className="group flex items-center gap-6 bg-neutral-950 hover:bg-neutral-900 transition-colors p-6"
            >
              ...
              <div className="flex-grow">
                <div className="text-xs text-amber-400 font-normal uppercase tracking-wider mb-1">
                  {e.type}
                </div>
                <h3 className="font-normal text-white text-lg group-hover:text-amber-300 transition-colors">
                  {e.title}
                </h3>
              ...
              <ArrowRight className="w-5 h-5 text-neutral-600 group-hover:text-amber-400 group-hover:translate-x-1 transition-all flex-shrink-0" />
            </motion.a>
          ))}
        </div>
      </div>
...
/* ────────────────────────────────────────────────────────────
   CLUBS — sección clara, cards de vida estudiantil
   ──────────────────────────────────────────────────────────── */
function Clubs() {
  const clubes = [
    {
      nombre: "Club de Astronomía",
      desc: "Observaciones, charlas y construcción de telescopios.",
      icon: Telescope,
    },
    {
      nombre: "Club de Robótica",
      desc: "Diseño y programación de robots para competencias.",
      icon: Cpu,
    },
    {
      nombre: "Club de Óptica",
      desc: "Experimentos con láseres, holografía y fibra óptica.",
      icon: Waves,
    },
    {
      nombre: "Club de Programación",
      desc: "Algoritmos, machine learning y física computacional.",
      icon: Brain,
    },
  ];
    ...
    <section className="bg-white py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-neutral-600 text-lg font-light leading-relaxed">
            Espacios de aprendizaje colaborativo donde los estudiantes exploran
            sus intereses científicos más allá del aula.
          </p>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-neutral-200">
          {clubes.map((c, i) => (
            <motion.a
              ...
              whileInView="show"
              viewport={{ once: true }}
              className="group block bg-white p-8 hover:bg-neutral-50 transition-colors"
            >
              <c.icon
                className="w-8 h-8 text-amber-500 mb-4 group-hover:text-amber-600 transition-colors"
                strokeWidth={1.5}
              />
              <h3 className="font-normal text-neutral-900 text-lg mb-2">
                {c.nombre}
              </h3>
...
/* ────────────────────────────────────────────────────────────
   CTA — llamada a la acción, sobria
   ──────────────────────────────────────────────────────────── */
function Cta() {
  return (
    <section className="bg-neutral-950 py-24 lg:py-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-neutral-400 text-lg font-light leading-relaxed mb-10 max-w-2xl mx-auto">
            Si eres estudiante de Física o Nanotecnología en Yachay Tech,
            contribuye al desarrollo científico del país junto a nosotros.
          </p>
...
/* ────────────────────────────────────────────────────────────
   FOOTER — completo, sobrio, acceso admin sutil
   ──────────────────────────────────────────────────────────── */
function Footer() {
  return (
