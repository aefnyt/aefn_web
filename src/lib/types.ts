...
/* ============================================================
   CARRUSEL DINÁMICO (página principal)
   ============================================================
   Lee de public/data/carrusel.json. Cada slide puede ser
   imagen o video (YouTube/Vimeo embebido).

   📚 Cómo añadir un slide desde GitHub:
   Edita public/data/carrusel.json y añade un objeto al array.
   Para imágenes: sube el archivo a public/welcome_screen/ y
   referencia su ruta relativa en "src".
   Para videos: sube el video a YouTube y pega la URL en "src".
   ============================================================ */

export type CarruselTipo = "imagen" | "video";

export interface CarruselSlide {
  /** Identificador único del slide */
  id: string;
  /** "imagen" para fotos locales, "video" para YouTube/Vimeo embebido */
  tipo: CarruselTipo;
  /**
   * Ruta de la imagen (relativa a public/) o URL del video.
   ...
   */
  src: string;
  /** Texto alternativo (accesibilidad). Opcional para videos. */
  alt?: string;
